import { getCharacters } from "./rickymortyapi";
...
export const getAndSaveRickyMortyCharacters = async (): Promise<Db> => {
  ...
  const url: string ="mongodb+srv://penelope:1998gpao@cluster0.38hvb.mongodb.net/RickyMorty?retryWrites=true&w=majority";
